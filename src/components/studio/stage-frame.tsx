...
export function StageFrame({
  ...
  async function callOnce(
    ...
    const result = illuminateApply(study.id, stage, payload, expectedRevision, opts.recordIds ? { appraisedRecordIds: opts.recordIds, ...(opts.batch ? { appraisalBatch: opts.batch } : {}) } : undefined);
